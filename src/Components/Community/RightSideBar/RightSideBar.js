...
const RightSideBar = () => {
  return (
    ...
    >
      <Card
        className="Card "
        style={{ width: "300px", height: "200px", borderRadius: "12px" ,marginTop:'7rem'}}
      >
        <div className="myra flex">
          <div className="img-col" >
          <img
            src={myra}
            style={{ height: "73px", weight: "63px", marginRight: "10rem",marginTop:'5px'}}
          />
         </div>
      ...
      <Card
        ...
        style={{
          ...
          display: "flex",
          width: "300px", height: "150px", borderRadius: "12px",marginTop:'1rem'
        }}
      >
