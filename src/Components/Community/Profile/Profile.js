...
const Profile = () => {
  //Creating functions to remove tags
  const hide1 = () => {
  ...
  return (
    <div className="profile flex flex-col relative w-screen md:w-full h-auto md:h-auto ">
      ...
      <div className="bg-white flex flex-col mx-auto w-11/12 md:w-10/12 rounded-xl shadow-lg mt-32">
        ...
        <div className="flex mx-auto mt-4 md:mt-8">
          <div className="flex mr-6">
            ...
            <div className="text-col text-xl pt-3 pl-2  text-gray-500">
              Female
            </div>
          </div>
          <div className="flex">
        ...
        <div className="mx-auto">
          <div className="flex">
            ...
            <div className="text-col text-xl pt-11 pl-2 pr-8 text-gray-500">
              she/her
            </div>
          </div>
        </div>
        ...
        <div className="font-semibold text-2xl ml-48 pt-8">
          Topics You follow:
        </div>
